...
const ModernLoadingContainer = styled('div')(({ theme }: { theme: Theme }) => ({
    background: '#000',
    width: '100%',
    height: '100%',
    borderRadius: theme.shape.borderRadius * 2,
...
const ModernLoadingText = styled('div')({
    color: '#fff',
    fontSize: 18,
    fontWeight: 500,
    letterSpacing: 1,
...
export default function CreateCamera() {
    ...
    const [stateCamera, setStateCamera] = useState<"loading" | "error" | "connected" | "init">("loading");
                                ...
                                <Box sx={{
                                    ...
                                    {stateCamera === "loading" && (
                                        ...
                                        <ModernLoadingContainer>
                                            ...
                                            <ModernLoadingText>Đang kết nối đến camera...</ModernLoadingText> */}
                                        </ModernLoadingContainer>
                                    )}
